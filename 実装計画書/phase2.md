...
> **2026-08-16追記**: フェーズ1〜8完了時点のレビューで、プライベートチャンネルのSTOMP経由の情報漏洩(重大)と`ChannelService.list()`のN+1クエリの指摘があった。詳細は[review-fixes-2026-08-16.md](review-fixes-2026-08-16.md)を参照。
