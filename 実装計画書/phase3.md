...
> **2026-08-16追記**: フェーズ1〜8完了時点のレビューで、`reactedByMe`が操作者視点のまま全購読者へ配信される不具合(重大)と、`MessageService`のService層認可(多層防御)の指摘があった。詳細は[review-fixes-2026-08-16.md](review-fixes-2026-08-16.md)を参照。
